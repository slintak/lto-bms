...
#define BMS_CUTOFF_3V3  PIN3_bm  // PB3
...
#define BMS_CUTOFF_OFF() do { PORTA.DIRSET |= BMS_CUTOFF; PORTA.OUTCLR = BMS_CUTOFF; } while(0)

// Turn on or off the 3.3 V output on the QWIIC connector.
#define BMS_CUTOFF_3V3_ON() do { PORTB.DIRCLR |= BMS_CUTOFF_3V3; } while(0)
#define BMS_CUTOFF_3V3_OFF() do { PORTB.DIRSET |= BMS_CUTOFF_3V3; PORTB.OUTCLR = BMS_CUTOFF_3V3; } while(0)
